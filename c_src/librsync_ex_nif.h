...
// argv[1]: 'new file' - Filename of new file to which the signature is applied, generating a delta file.
// argv[2]: 'delta file' - Filename of file in which delta will be written.
// Returns: :ok atom or {:error, rs_result status code}.
static ERL_NIF_TERM librsync_ex_nif_rs_delta_file(ErlNifEnv *env, int argc, const ERL_NIF_TERM argv[]);

// argv[0]: 'basis file' - Filename of basis file to which the delta will be appliec.
// argv[1]: 'delta file' - Filename of delta file.
// argv[2]: 'new file' - Filename in which to write the new patched version of 'basis file'.
// Returns: :ok atom or {:error, rs_result status code}.
...
static ErlNifFunc nif_funcs[] = {
  ...
  {"nif_rs_sig_file", 5, librsync_ex_nif_rs_sig_file, ERL_NIF_DIRTY_JOB_IO_BOUND},
  {"nif_rs_delta_file", 3, librsync_ex_nif_rs_delta_file, ERL_NIF_DIRTY_JOB_IO_BOUND},
  {"nif_rs_patch_file", 3, librsync_ex_nif_rs_patch_file, ERL_NIF_DIRTY_JOB_IO_BOUND}
};
